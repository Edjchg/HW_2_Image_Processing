function imagen_limpia=fast_median_filter_v2(I)
  ...
  median_vector=uint8(zeros(1,3));% Creando un vector de tamaño 3 para hacer el vector de medianas.
  A=uint8(zeros(1,3));% Creando un vector de tamaño 3 para hacer el vector A.
  B=uint8(zeros(1,3));% Creando un vector de tamaño 3 para hacer el vector B.
  C=uint8(zeros(1,3));% Creando un vector de tamaño 3 para hacer el vector C.
  for z=1:k 
    for i=1:m
