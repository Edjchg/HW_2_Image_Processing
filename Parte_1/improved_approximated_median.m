function imagen_limpia = improved_approximated_median(I)
  ...
  for z=1:k % Recorriendo los canales de la imagen.
    for i=2:m-1 % Recorriendo filas de la imagen.
      ...
      %A = mid_value_decision_median([I(i-1,1,z) I(i,1,z) I(i+1,1,z)]);% Tomando el nuevo pixel de la columna A.
      %B = mid_value_decision_median([I(i-1,2,z) I(i,2,z) I(i+1,2,z)]);% Tomando el nuevo pixel de la columna B.
      for j=3:n % Recorriendo columnas de la imagen.
        ...
        %C = mid_value_decision_median([I(i-1,j,z) I(i,j,z) I(i+1,j,z)]); %Tomando el nuevo píxel de la columna C.
