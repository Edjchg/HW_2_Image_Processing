%-*- texinfo -*-
%@deftypefn {Function File} {@var{pixel} =}  mid_value_decision_median()
%Function mid_value_decision_median()
%@end deftypefn

function pixel=mid_value_decision_median(P,len)
  % Este metodo elige el pixel mas ideoneo del arreglo P de tres pixeles medios.
