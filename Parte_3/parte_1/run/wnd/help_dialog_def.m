...
function ret = show_help_dialog()
  ...
  _xPos = (_scrSize(3) - 144)/2;
  _yPos = (_scrSize(4) - 0)/2;
   help_dialog = figure ( ... 
	'Color', [0.941 0.941 0.941], ...
	'Position', [_xPos _yPos 144 0], ...
	'resize', 'off', ...
	'windowstyle', 'normal', ...
	'MenuBar', 'none');
...
%
global _parte_1ImgPath;

%Direccion donde se encuentra la imagen
text=fullfile(_parte_1ImgPath,'help_parte1.png');
