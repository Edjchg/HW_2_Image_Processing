...
function ret = show_main()
  ...
  _yPos = (_scrSize(4) - 450)/2;
   main = figure ( ... 
	'Color', [0.941 0.941 0.941], ...
	'Position', [_xPos _yPos 722 450], ...
	'resize', 'off', ...
	'windowstyle', 'normal', ...
	'MenuBar', 'none');
