...
function ret = show_main()
  ...
  _xPos = (_scrSize(3) - 681)/2;
  _yPos = (_scrSize(4) - 650)/2;
   main = figure ( ... 
	'Color', [0.941 0.941 0.941], ...
	'Position', [_xPos _yPos 681 650], ...
	'resize', 'off', ...
	'windowstyle', 'normal', ...
	'MenuBar', 'none');
